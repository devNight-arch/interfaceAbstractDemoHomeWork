...
public class KPSPublicSoapProxy implements tr.gov.nvi.tckimlik.WS.KPSPublicSoap {
  ...
  public boolean TCKimlikNoDogrula1(long TCKimlikNo, java.lang.String ad, int i, int dogumYili) throws java.rmi.RemoteException{
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
    return kPSPublicSoap.TCKimlikNoDogrula(TCKimlikNo, ad, i, dogumYili);
  }

public boolean TCKimlikNoDogrula(long parseLong, String upperCase, int i, int dogumYili) {
